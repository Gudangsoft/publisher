    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="bg-white rounded-xl shadow-xl max-w-md w-full relative z-10 p-6">
            ...
            <div class="space-y-4">
                ...
                <input type="hidden" id="newCategoryType" value="book">
            </div>
...
function submitNewCategory() {
    ...
    if (!name) {
        alert.className = 'mb-4 px-4 py-3 rounded-lg text-sm bg-red-100 text-red-700 border border-red-300';
        alert.textContent = 'Nama kategori wajib diisi.';
    ...
    .then(data => {
        if (data.success) {
            ...
            alert.className = 'mb-4 px-4 py-3 rounded-lg text-sm bg-red-100 text-red-700 border border-red-300';
            alert.textContent = data.message || 'Gagal menambahkan kategori.';
            alert.classList.remove('hidden');
        }
    })
    .catch(err => {
