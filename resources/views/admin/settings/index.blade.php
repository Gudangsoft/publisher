...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" x-data="{ active: 'general' }">
            ...
            <nav class="p-2">
                ...
                <button @click="active = 'homepage'" :class="active === 'homepage' ? 'bg-primary-50 text-primary-700' : 'text-gray-700 hover:bg-gray-50'" class="w-full flex items-center px-4 py-3 rounded-lg transition-colors duration-200 mb-1">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="lg:col-span-2">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6" x-data="{ active: 'general' }">
            ...
            <!-- Homepage Settings -->
            <div x-show="active === 'homepage'" x-cloak>
                <h2 class="text-xl font-bold text-gray-900 mb-6">Pengaturan Halaman Utama</h2>
                ...
                <form action="{{ route('admin.settings.update') }}" method="POST" class="space-y-6">
                    ...
                    <div class="border-b pb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Bagian: Buku Pilihan</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Judul</label>
                                <input type="text" name="home_books_title" value="{{ $settings['home_books_title'] ?? 'Buku Pilihan' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Subjudul / Deskripsi</label>
                                <input type="text" name="home_books_subtitle" value="{{ $settings['home_books_subtitle'] ?? 'Koleksi buku terbaik dan terpopuler yang wajib Anda baca' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                        </div>
                    </div>

                    <div class="border-b pb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Bagian: Kategori Buku</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Judul</label>
                                <input type="text" name="home_categories_title" value="{{ $settings['home_categories_title'] ?? 'Kategori Buku' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Subjudul / Deskripsi</label>
                                <input type="text" name="home_categories_subtitle" value="{{ $settings['home_categories_subtitle'] ?? 'Temukan buku sesuai dengan minat dan kebutuhan Anda' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                        </div>
                    </div>

                    <div class="border-b pb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Bagian: Jurnal Ilmiah</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Judul</label>
                                <input type="text" name="home_journals_title" value="{{ $settings['home_journals_title'] ?? 'Jurnal Ilmiah' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Subjudul / Deskripsi</label>
                                <input type="text" name="home_journals_subtitle" value="{{ $settings['home_journals_subtitle'] ?? 'Akses publikasi akademik dan penelitian terkini dari berbagai bidang ilmu' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                        </div>
                    </div>

                    <div class="border-b pb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Bagian: Berita Terkini</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Judul</label>
                                <input type="text" name="home_news_title" value="{{ $settings['home_news_title'] ?? 'Berita Terkini' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Subjudul / Deskripsi</label>
                                <input type="text" name="home_news_subtitle" value="{{ $settings['home_news_subtitle'] ?? 'Update terbaru seputar dunia literasi dan buku' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                        </div>
                    </div>

                    <div class="pb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Bagian: Testimoni</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Judul</label>
                                <input type="text" name="home_testimonials_title" value="{{ $settings['home_testimonials_title'] ?? 'Apa Kata Pembaca Kami' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Subjudul / Deskripsi</label>
                                <input type="text" name="home_testimonials_subtitle" value="{{ $settings['home_testimonials_subtitle'] ?? 'Kepuasan pembaca adalah prioritas kami. Lihat apa kata mereka tentang buku-buku kami' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                            </div>
                        </div>
                    </div>
