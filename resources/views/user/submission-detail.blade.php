...
<div class="bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        $statusConfig = [
            ...
            'in_review' => ['bg' => 'bg-blue-50', 'border' => 'border-blue-200', 'text' => 'text-blue-800', 'icon' => 'eye', 'label' => 'Sedang Direview', 'description' => 'Naskah Anda sedang dalam proses review oleh tim editor.'],
            'revision_required' => ['bg' => 'bg-orange-50', 'border' => 'border-orange-200', 'text' => 'text-orange-800', 'icon' => 'edit', 'label' => 'Perlu Revisi', 'description' => 'Naskah Anda memerlukan beberapa revisi. Silakan lihat catatan dari editor di bawah.'],
            ...
            'in_production' => ['bg' => 'bg-purple-50', 'border' => 'border-purple-200', 'text' => 'text-purple-800', 'icon' => 'printer', 'label' => 'Dalam Produksi', 'description' => 'Naskah Anda sedang dalam tahap produksi/pencetakan.'],
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                @if($submission->revision_notes && in_array($submission->status, ['revision_required', 'rejected']))
