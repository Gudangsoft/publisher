    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0 lg:w-20'" 
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
            <ul class="space-y-2 font-medium">
                ...
                <!-- Gallery Management -->
                <li>
                    <a href="{{ route('admin.galleries.index') }}" class="flex items-center p-3 text-gray-900 rounded-lg hover:bg-primary-50 group {{ request()->is('admin/galleries*') ? 'bg-primary-50 text-primary-600' : '' }}">
                        <svg class="w-5 h-5 transition duration-75 {{ request()->is('admin/galleries*') ? 'text-primary-600' : 'text-gray-500 group-hover:text-primary-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        <span :class="sidebarOpen ? 'ml-3' : 'lg:hidden ml-3'">Galeri Foto & Video</span>
                    </a>
                </li>
